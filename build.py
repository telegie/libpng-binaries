...
def build_x64_windows_binaries():
    ...
    subprocess.run(["cmake",
                    ...
                    "-D", f"ZLIB_ROOT={here}/zlib-binaries/output/x64-windows"],
                   check=True)
...
def build_arm64_mac_binaries():
    ...
    subprocess.run(["cmake",
                    ...
                    "-D", f"ZLIB_ROOT={here}/zlib-binaries/output/arm64-mac",
                    "-D", "PNG_SHARED=0",
                    "-D", "PNG_ARM_NEON=off"],
                   check=True)
...
def build_x64_mac_binaries():
    ...
    subprocess.run(["cmake",
                    ...
                    "-D", f"ZLIB_ROOT={here}/zlib-binaries/output/x64-mac",
                    "-D", "PNG_SHARED=0",
                    "-D", "PNG_ARM_NEON=off"],
                   check=True)
...
def build_x64_linux_binaries():
    ...
    subprocess.run(["cmake",
                    ...
                    "-D", f"ZLIB_ROOT={here}/zlib-binaries/output/x64-linux",
                    "-D", "PNG_SHARED=0",
